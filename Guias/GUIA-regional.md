...
- **➕ Criar conta** (municípios sem conta): escolha **e-mail automático** (`municipio@vigiagua.pr.gov.br`) ou **informe um e-mail real**, confirme a senha temporária e crie. O sistema mostra o e-mail + a senha temporária para você repassar; o município define a senha dele no 1º acesso.
- **🔑 Resetar senha** — gera uma nova senha temporária (o município troca no próximo acesso). Serve também para **recuperar** o acesso de quem esqueceu a senha (contas com e-mail fake).
- **✉️ Trocar e-mail** — troca o e-mail de uma conta (ex.: de automático para real). A senha não muda.

> **Diferença fake × real:** só na recuperação. Com **e-mail real**, o município recupera a senha sozinho por e-mail. Com **e-mail fake**, a recuperação é você, no painel, com "Resetar senha".
>
> **Login de conta com e-mail real:** esse município entra por **"entrar com e-mail"** (digitando o e-mail), não pela lista de nomes. A lista de nomes usa sempre o e-mail automático.
