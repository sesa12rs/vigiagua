...
- **Criar conta** (e-mail automático/fake ou real) com senha temporária.
- **Resetar senha** (gera nova temporária — é também a recuperação para contas com e-mail fake).
- **Trocar e-mail** (migrar de fake para real).
...
> Contas com **e-mail real** logam por "entrar com e-mail" (a lista de nomes usa o e-mail automático). Elas também podem usar a recuperação por e-mail do Supabase.
